...
export const SEED_LISTINGS: Listing[] = [
  ...
  { id: "l3", title: "Quiet 2-bed near Thanh Khê Beach", type: "Apartment", price: 1990, beds: 2, baths: 1, area: 84, district: District.ThanhKhe, city: "Da Nang", palette: 6, amenities: ["wifi", "pets", "garden", "laundry"], owner: "you", status: "active", views: 244, available: "now", desc: "Calm tree-lined block, a few minutes' stroll to Thanh Khê Beach. Tiled floors, a sunny breakfast nook, and a shared back garden." },
  ...
  { id: "l7", title: "Beachside house in Nam Ô", type: "House", price: 3200, beds: 4, baths: 2, area: 168, district: District.LienChieu, city: "Da Nang", palette: 5, amenities: ["wifi", "parking", "pets", "garden", "laundry"], owner: "leo", status: "active", views: 276, available: "now", desc: "Restored house near Nam Ô Beach with original built-ins and a wraparound porch. Big kitchen, mature garden, and easy reach to Liên Chiểu's seafood spots." },
